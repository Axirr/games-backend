...
urlpatterns = [
             path('graph/<str:dataName>/<str:timeGroup>/<str:noWeekend>/<str:minZero>/<str:graphType>/<str:normalizeData>/<str:noLegend>/<str:fromFirstValidDate>/<str:onlyIntersection>/<str:shiftValue>/', views.refreshGraph, name='refreshGraph'),
